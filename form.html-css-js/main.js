...
inputs.forEach((input, index) => /* on parcours le tableau de inputs avec une boucle .forEach*/ {
    ...
    input.addEventListener('blur', function() {
        if (this.value == "") /**avant en vérifie si le input n'ai pas vide si non en laisse l'animation comme elle et en fait rien */ { inputText.classList.remove('focus'); /*annule l'animation */ }
    });
});